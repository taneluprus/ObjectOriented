...
//RÖÖPÜHENDUS
var ParalellCircuit = /** @class */ (function () {
    function ParalellCircuit() {
        this.resistors = [];
    }
    ParalellCircuit.prototype.push = function (r) {
        this.resistors.push(r);
    };
    ParalellCircuit.prototype.getTotalResistance = function () {
        var sum = 0;
        this.resistors.forEach(function (r) { sum += 1 / (r.GetResistance()); });
        return 1 / sum;
    };
    return ParalellCircuit;
}());
//VÕIMSUSE ARVUTAMINE
